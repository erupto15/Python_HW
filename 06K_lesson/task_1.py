...
class TestFormFilling(unittest.TestCase):
    ...
    def test_fill_form(self):
        ...
        self.assertIn("invalid", zip_code_input.get_attribute("class"), "Поле zip code не подсвечено красным")
        ...
        for field in green_fields:
            ...
            self.assertIn("valid", element.get_attribute("class"), f"Поле {field} не подсвечено зеленым")
